...
router.get('/users/:uid/calendar/',                 controllers.calendar.getById);
router.post('/users/:uid/calendar/',                controllers.calendar.setById);
...
router.post('/users/:uuid/trips',                   controllers.trips.create);
